...
\begin{document}
	...
	\input{Präamble/Eigenleistung.tex}
	\newpage

	%------------- Abstract -------------
	\input{./Präamble/abstract}
	\newpage
	...
	%------------- Einleitung -------------
	\chapter{Einleitung}
	\input{./Einleitung/Motivation}
	\newpage
	\input{./Einleitung/Zielsetzung}
	\newpage
	\input{./Einleitung/Ziel der Arbeit}
	\newpage
	
	% ------------- Hauptteil -------------

	\chapter{Theoretische Grundlagen}
	\input{Theroretische Grundlagen/TheoretischeGrundlagenSchnittstellen}
	\input{Theoretische Grundlagen/TG_Scrum}
	\input{Theoretische Grundlagen/TG_APIs}
	\input{Theoretische Grundlagen/TG_Designprinzipien}
	%\input{Theroretische Grundlagen/TG_example}
	\input{Theoretische Grundlagen/SPAs}
	\input{Theoretische Grundlagen/MobileApps}
	\input{Theoretische Grundlagen/UIUX}
    \input{Theoretische Grundlagen/Testing}

	\newpage
	
	\chapter{Anforderungen}
	\input{Anforderungen/Frontend}
  ...
  \input{Anforderungen/AnforderungenAnSchnittstellenServices}
  \input{Anforderungen/Anf_Backend}
	%\input{Anforderungen/Anforderungen_example}
	
	\newpage
	
	\chapter{Auswahl der Technologien}
	\input{Auswahl der Technologien/Vue}
	\input{Auswahl der Technologien/Pinia}
	\input{Auswahl der Technologien/CSS}
	\input{Auswahl der Technologien/Capacitor}
	\input{Auswahl der Technologien/I18n}
  \input{Auswahl der Technologien/AuswahlDerTechnologienSchnittstellenservices}
	\input{Auswahl der Technologien/AdT_Programmiersprache_BFF}
	\input{Auswahl der Technologien/AdT_Datenbankentscheidung}
	%\input{Auswahl der Technologien/AdT_example}
	
	\newpage
	
	\chapter{Umsetzung}
  \input{Umsetzung/UmsetzungSchnittstellenservices}
	\input{Umsetzung/Ums_Datenmodellierung und Datenfluss}
	%\input{Umsetzung/Umsetzung_example}
	\input{Umsetzung/Frontend-Architektur}
	\input{Umsetzung/UIUX}
	\input{Umsetzung/KI-Erkennung}
	\input{Umsetzung/Spezifische_Komponenten_Frontend}
	...
	\input{Kritische Reflexion/Frontend}
	%\input{Kritische Reflexion/Kritische_Reflexion_example}
	
	\newpage 
	
	\chapter{Ausblick}
	\input{Ausblick/Frontend}
	%\input{Ausblick/Ausblick_example}
